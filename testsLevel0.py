...
def get_test(index):
    if index == 0:
        ...
        test0[0].apply(Art.Scale(5))
        test0[0].apply(Art.Translate([-20, 20]))
        test0[1].apply(Art.Scale(5))
        test0[1].apply(Art.Translate([-15, 35]))
        return test0
    ...
    if index == 2:
        ...
        test2[0].apply(Art.Scale(5))
        test2[0].apply(Art.Translate([-30, 30]))
        test2[1].apply(Art.Scale(2))
        return test2
